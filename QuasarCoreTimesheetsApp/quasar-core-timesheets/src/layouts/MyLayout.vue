      ...
      >
        <q-list>
          <q-item :to="{name: 'index'}" exact clickable v-if="isAuthenticated">
            ...
            <q-item-section>
              <q-item-label>{{ $t('message.myTimesheets') }}</q-item-label>
            </q-item-section>
          </q-item>
          <q-item :to="{name: 'overview'}" clickable v-if="isManager">
            ...
            <q-item-section>
              <q-item-label>{{ $t('message.overview') }}</q-item-label>
            </q-item-section>
          </q-item>
          <q-item :to="{name: 'register'}" clickable v-if="!isAuthenticated">
            ...
            <q-item-section>
              <q-item-label>{{ $t('message.register') }}</q-item-label>
            </q-item-section>
          </q-item>
          <q-item :to="{name: 'login'}" clickable v-if="!isAuthenticated">
            ...
            <q-item-section>
              <q-item-label>{{ $t('message.login') }}</q-item-label>
            </q-item-section>
          </q-item>
          <q-item clickable v-if="isAuthenticated" @click="logout">
            ...
            <q-item-section>
              <q-item-label>{{ $t('message.logout') }}</q-item-label>
            </q-item-section>
          </q-item>
        </q-list>
      </q-drawer>
      ...
      refreshToken(){
        ...
        if(includedRoutes.includes(this.$route.name)){
          api.refreshToken().then(response => {
            ...
            if(routeCheck.validate('/login', this.$route.path)){
