          ...
          <tbody v-for="person in people">
            ...
            <tr>
              ...
              <td v-for="entry in person.entries" :class="entry.class">
                <div v-if="entry.canStart">
                  <q-btn size="sm" color="primary" :label="$t('message.start')" @click="start(entry)"></q-btn>
                </div>
                <div v-else>
            ...
            <tr>
              ...
              <td v-for="entry in person.entries" :class="entry.class">
                <div v-if="entry.canEnd">
                  <q-btn size="sm" color="primary" :label="$t('message.end')" @click="end(entry)"></q-btn>
                </div>
                <div v-else>
            ...
            <tr v-if="!isOverview">
              ...
              <td v-for="entry in person.entries">
                <q-btn size="sm" color="secondary" :label="$t('message.absence')" @click="setAbsence(entry)" v-if="entry.canSetAbsence"></q-btn>
                <q-btn size="sm" color="secondary" :label="$t('message.deleteAbsence')" @click="deleteAbsence(entry)" v-if="entry.canDeleteAbsence"></q-btn>
              </td>
              <td>
              </td>
            </tr>
...
export default {
  ...
  methods:{
    ...
    async setAbsence(entry){
      this.$q.dialog({
        title: this.$t('message.absence'),
        message: this.$t('message.absenceReason'),
        prompt: {
          model: '',
          type: 'text'
        },
